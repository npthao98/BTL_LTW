...
<body>
    <div class="search_cake undisplay">
        <svg width="30px" class="svg-search-opener" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 28 28" style="enable-background:new 0 0 28 28;" xml:space="preserve">
            <g>
        ...
        <input onkeyup="set_context('${pageContext.request.contextPath}', event)"
