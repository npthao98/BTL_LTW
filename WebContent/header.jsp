...
<!-- 	<link rel="stylesheet" href="css/header.css"> -->
	<div class="header">
	    <div class="header--contact content-header">
	    ...
	    <div class="header--navbar">
	        ...
	        <div class="header--navbar_item">home</div>
	        <div class="header--navbar_item">blog</div>
	        <div class="header--navbar_item">portfolio</div>
	        <div class="header--navbar_item">shop</div>
